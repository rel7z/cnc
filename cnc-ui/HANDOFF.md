...
| 2026-09-17 | Antigravity | Added two-way Google Drive synchronization, line-based deduplication, in-place file updates, automatic multi-duplicate cleanup, and background development server deployment. |
